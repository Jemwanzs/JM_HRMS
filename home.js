...
function updateDashboard() {
    ...
    employees.forEach(employee => {
        ...
        const totalDeductionsForEmployee = paye + nssf + shif + ahl + wht + otherDeductions;
    ...
    document.getElementById('tshif').textContent = formatWithCommas(tshif.toFixed(2));
...
function calculatePAYE(grossSalary) {
    ...
    //const taxableIncome = grossSalary - nssfAmount; SHIF AND AHL became allowable deductions from Dec 27, 2024
    const taxableIncome = grossSalary - nssfAmount - shifAmount - ahlAmount;
    //const nhifAmount = calculateNHIF(grossSalary);
    const personalRelief = 2400;
    //const insuranceRelief = 0.15 * nhifAmount; nhif shifted to shif
    //const insuranceRelief = 0.15 * shifAmount; shif relief ceased to apply from oct 2024
    const insuranceRelief = 0 * shifAmount;
    //const ahlRelief = 0.15 * ahlAmount; AHL relief ceased to apply from Dec 2024
    const ahlRelief = 0 * ahlAmount;
